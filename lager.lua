...
local function renderNormalCenter(dt, frame)
  ...
  if h >= 7 then
    centerText(centerMon, 2, "COLIN x MARCEL", colors.white, colors.black)
    local dotsCol = (dt.sec % 2 == 0) and colors.cyan or colors.orange
    centerText(centerMon, math.floor(h / 2) - 1, ":", dotsCol, colors.black)
    centerText(centerMon, math.floor(h / 2), string.format("SEK %02d", dt.sec), pulse, colors.black)
    ...
    centerText(centerMon, 2, "COLIN x MARCEL", colors.white, colors.black)
    centerText(centerMon, math.max(3, math.floor(h / 2)), string.format("SEK %02d", dt.sec), pulse, colors.black)
...
local function renderParty(frame, legend)
  ...
  centerText(centerMon, 2, "COLIN x MARCEL", colors.yellow, colors.black)
  centerText(centerMon, math.max(4, math.floor(h / 2)), centerWord, colors.white, colors.black)
  if h >= 7 then
...
local function splash()
  for _, mon in ipairs({ leftMon, centerMon, rightMon }) do
    ...
    centerText(mon, math.max(3, math.floor(h / 2)), "MEGA CLOCK", colors.white, colors.black)
